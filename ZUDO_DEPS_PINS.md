...
- updated: 2026-08-29
- notes: The two doc route stubs are patched for doc history, check-links.js preserves unquoted-attribute support for minified zfb HTML (zudolab/zudo-doc#3720), and global.css carries host branding; preserve the intentional divergences in .template-drift-allowlist and the package scripts' explicit `codemirror-wisdom` skill-name arguments, while non-allowlisted scaffold files must match upstream exactly.
